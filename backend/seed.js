...
const sampleMovies = [
  { title: 'The Shawshank Redemption', overview: 'Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.', releaseDate: '1994-09-23', genres: ['Drama'], type: 'movie', posterPath: 'https://image.tmdb.org/t/p/w500/9cjIGRQL1mlUoLfRjfpZLjyUGrR.jpg' },
  { title: 'The Dark Knight', overview: 'When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, Batman must accept one of the greatest psychological and physical tests of his ability to fight injustice.', releaseDate: '2008-07-18', genres: ['Action', 'Drama', 'Thriller'], type: 'movie', posterPath: 'https://image.tmdb.org/t/p/w500/qJ2tW6WMUDux911BTUgMe1nEabl.jpg' },
