...
const sampleMovies = [
  { title: 'The Shawshank Redemption', overview: 'Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.', releaseDate: '1994-09-23', genres: ['Drama'], type: 'movie', posterPath: 'https://picsum.photos/seed/shawshank1994/200/300.jpg', cast: [{ name: 'Tim Robbins', character: 'Andy Dufresne' }, { name: 'Morgan Freeman', character: 'Red' }] },
  { title: 'The Dark Knight', overview: 'When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, Batman must accept one of the greatest psychological and physical tests of his ability to fight injustice.', releaseDate: '2008-07-18', genres: ['Action', 'Drama', 'Thriller'], type: 'movie', posterPath: 'https://picsum.photos/seed/darkknight2008/200/300.jpg', cast: [{ name: 'Christian Bale', character: 'Bruce Wayne' }, { name: 'Heath Ledger', character: 'Joker' }] },
  ...
  { title: 'Saving Private Ryan', overview: 'Following the Normandy Landings, a group of U.S. soldiers go behind enemy lines to retrieve a paratrooper whose brothers have been killed in action.', releaseDate: '1998-07-24', genres: ['Drama', 'War'], type: 'movie', posterPath: 'https://image.tmdb.org/t/p/w500/mjUS4XZGgbxXxKUQX7E8Z4Z4.jpg', cast: [{ name: 'Tom Hanks', character: 'Captain Miller' }, { name: 'Matt Damon', character: 'Private Ryan' }] },
  { title: 'The Dark Knight Rises', overview: 'Eight years after the Joker\'s reign of anarchy, the Dark Knight is forced to return to confront the mercenary Bane.', releaseDate: '2012-07-20', genres: ['Action', 'Drama', 'Thriller'], type: 'movie', posterPath: 'https://image.tmdb.org/t/p/w500/hTkELJ6qX7X7X7X7X7X7X7X7X7X7X7X.jpg', cast: [{ name: 'Christian Bale', character: 'Bruce Wayne' }, { name: 'Tom Hardy', character: 'Bane' }] },
